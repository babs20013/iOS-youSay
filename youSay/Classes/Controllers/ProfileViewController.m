...
- (UITableViewCell*)constructCellForProfilePage:(NSIndexPath*)indexPath forTableView:(UITableView*)tableView {
    ...
    if(indexPath.section == 0)
    {
        ...
        if(isFriendProfile && !isNOTFirstTimeOnFriendProfile && !tooltipIsVisible && profileDictionary){
            ...
            //tip
            UITooltip *tip1 = [[UITooltip alloc]initWithFrame:CGRectMake((background.frame.size.width-210)/2, (background.frame.size.height-99)/2, 242, 114)];
            tip1.tipArrow = TipArrowBottomLeft;
            ...
            UITooltip *tip2 = [[UITooltip alloc]initWithFrame:CGRectMake(tip2x, tip2y, 185, 73)];
            tip2.tipArrow = TipArrowMiddleRight;
            tip2.tooltipText = [NSString stringWithFormat:@"Click on the + icon to write something awesome about %@",model.Name];
